...
for PARTITION in ['train', 'test', 'val']:
    dataset = json.load(open(f"Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}.json", 'r'))
    ...
    json.dump(dataset, open(f"Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_syntax_tree.json", 'w'), indent=4)