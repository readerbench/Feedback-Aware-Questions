...
dataset = json.load(open(f'Feedback-Aware-Questions/tasa_dataset_preparation/tasa_{PARTITION}_answers_questions.json'))
...
json.dump(dataset, open(f'Feedback-Aware-Questions/tasa_dataset_preparation/tasa_{PARTITION}_answers_questions_quality_scores_sum_no_context.json', 'w'), indent=4)