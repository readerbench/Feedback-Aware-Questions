...
# Save the datasets
json.dump(train, open('Feedback-Aware-Questions/tasa_train.json', 'w'))
json.dump(test, open('Feedback-Aware-Questions/tasa_test.json', 'w'))
json.dump(val, open('Feedback-Aware-Questions/tasa_val.json', 'w'))