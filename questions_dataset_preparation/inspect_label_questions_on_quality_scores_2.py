...
dataset_t_1 = json.load(open('Feedback-Aware-Questions/tasa_dataset_preparation/tasa_train_answers_questions_quality_scores_sum_no_context.json'))
dataset_f_1 = json.load(open('Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_train_answers_questions_quality_scores_sum_no_context.json'))

dataset_t = json.load(open('Feedback-Aware-Questions/tasa_dataset_preparation/tasa_train_answers_questions_quality_scores_sum.json'))
dataset_f = json.load(open('Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_train_answers_questions_quality_scores_sum.json'))
