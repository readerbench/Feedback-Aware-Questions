...
model_name = "readerbench/llama3_8b_qgen"
...
dataset = json.load(open(f"Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_syntax_tree.json", 'r'))
batch_size = 8
...
json.dump(dataset, open(f"Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions.json", 'w'), indent=4)