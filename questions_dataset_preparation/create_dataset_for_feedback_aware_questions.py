...
json.dump(new_dataset, open(f'Feedback-Aware-Questions/questions_dataset_preparation/tasa_fairytaleqa_{PARTITION}_answers_questions_feedback_aware_v2.json', 'w'), indent=4)