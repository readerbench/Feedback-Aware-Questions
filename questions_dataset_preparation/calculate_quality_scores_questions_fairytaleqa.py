...
dataset = json.load(open(f'Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions.json'))

model_name = "readerbench/llama3_8b_qans"
...
json.dump(dataset, open(f'Feedback-Aware-Questions/fairytaleqa_dataset_preparation_question/fairytaleqa_{PARTITION}_answers_questions_quality_scores_sum_no_context.json', 'w'), indent=4)