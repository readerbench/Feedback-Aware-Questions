...
dataset = json.load(open(f"Feedback-Aware-Questions/tasa_dataset_preparation/tasa_{PARTITION}_syntax_tree.json", 'r'))
...
json.dump(dataset, open(f"Feedback-Aware-Questions/tasa_dataset_preparation/tasa_{PARTITION}_answers_questions.json", 'w'), indent=4)