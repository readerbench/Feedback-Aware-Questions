...
model_name = "readerbench/llama3_8b_questions_answer_selection_baseline_all_pairs_with_aid_generation_v2"
tokenizer = AutoTokenizer.from_pretrained(model_name, padding_side="left", token='ANONIMIZED')
tokenizer.pad_token_id = 128002
eos_id = tokenizer.encode(' }')[1]

model = AutoModelForCausalLM.from_pretrained(model_name, device_map="auto", token='ANONIMIZED')

tokenizer_qans = AutoTokenizer.from_pretrained("readerbench/llama3_8b_qans", padding_side="left", token='ANONIMIZED')
tokenizer_qans.pad_token_id = 128002
model_qans = AutoModelForCausalLM.from_pretrained("readerbench/llama3_8b_qans", device_map="auto", token='ANONIMIZED', torch_dtype=torch.bfloat16)

tokenizer_qgen = AutoTokenizer.from_pretrained("readerbench/llama3_8b_qgen", padding_side="left", token='ANONIMIZED')
tokenizer_qgen.pad_token_id = 128002
model_qgen = AutoModelForCausalLM.from_pretrained("readerbench/llama3_8b_qgen", device_map="auto", token='ANONIMIZED', torch_dtype=torch.bfloat16)
