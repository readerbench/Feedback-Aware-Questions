...
gpt_samples = json.load(open("Feedback-Aware-Questions/experiments/gpt_sample_all_one_shot.json", "r"))
data_test = data_test
...
json.dump(test_generated_list, open('Feedback-Aware-Questions/experiments/tasa_fairytaleqa_test_all_gpt_one_shot.json', 'w'), indent=4)
